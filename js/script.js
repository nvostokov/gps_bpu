...
function initMap() {
  ...
  }).setView([64.15677190486244, 42.32000911510506], scaleMap);
...
omnivore.kml('kml/bpu_3cat.kml', null, customLayer).addTo(map); 
...
// this can be any kind of omnivore layer
omnivore.kml('kml/bpu_5cat.kml', null, customLayer2).addTo(map);
